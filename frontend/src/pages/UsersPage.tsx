          ...
          <td colSpan={7} className="px-8 py-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
              {filteredApps.map(app => (
                <div key={app.name} className="flex items-center justify-between gap-2 bg-white rounded-lg px-3 py-2 border border-gray-200">
                  <span className="text-sm text-gray-900 truncate">{app.name}</span>
                  <div className="flex items-center gap-2 flex-shrink-0">
                    <span className="text-xs text-gray-500 font-medium">{app.launch_count}×</span>
